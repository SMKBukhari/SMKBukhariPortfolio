...
export const projectsData = [
  {
    id: 1,
    name: "Endvor - Digital Services Company Website",
    description:
      "I have developed a website for my company called Endvor. The website consist of Home Page, About Page, Services Page, Portfolio Page, Contact Page, Blog Page, and Footer. The website is built using Next.js, Tailwind CSS and deployed on Vercel.",
    tools: [
      "JSX",
      "Tailwind CSS",
      "Next JS",
